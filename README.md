...
\* \*\*TTUR (Two Time-Scale Update Rule):\*\* Learning rate differenziati ($LR\_G = 0.0002$, $LR\_D = 0.0001$) per garantire che il Generatore abbia il tempo di apprendere senza essere surclassato immediatamente.
